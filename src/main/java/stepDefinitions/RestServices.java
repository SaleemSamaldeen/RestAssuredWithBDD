...
public class RestServices extends BaseClass {
    ...
    private final String wa_key = "coding-puzzle-client-449cc9d";
    private String carBrandCode;
    private String carBrandName;
    private String carModelName;
    static Map<String, CarTypes> carModelType = new HashMap<>();
    private static Map<String, BuiltYear> carModelBuiltYears = new HashMap<>();
    private List<String> carTypesList = new ArrayList<>();
    private List<String> dataValidation = new ArrayList<>();
    static Map<String, Map<String, BuiltYear>> allCarBuiltYears = new HashMap<>();
    private String pathParameter;
    private CarBrands availableCarBrands;
    String valueToPrint;
